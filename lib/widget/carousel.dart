                                ...
                                children: [
                                  Container(
                                    child: Row(
                                      children: [
                                        Text(
                                          "${title[0]}",maxLines: 1,softWrap: false, overflow: TextOverflow.ellipsis,
                                          style: TextStyle(
                                            fontSize: 20,
                                  ...
                                  Container(
                                    child: Row(
                                      children: [
                                        ...
                                        Text("${type[0]}",overflow: TextOverflow.clip,),
                                      ],
                                    ),
                                  ),
                                  SizedBox(
                                    ...
                                    child: Row(
                                      children: [
                                        SizedBox(
                                          width:150,
                                          child: Text(
                                          "${title[1]}",maxLines: 1,softWrap: false, overflow: TextOverflow.ellipsis,
                                          style: TextStyle(
                                            fontSize: 20,
                                            fontWeight: FontWeight.w500,
                                          ),
                                ...
                                children: [
                                  Container(
                                    child: Row(
                                      children: [
                                        Text(
                                          "${title[2]}",maxLines: 1,softWrap: false, overflow: TextOverflow.ellipsis,
                                          style: TextStyle(
                                            fontSize: 20,
                                            fontWeight: FontWeight.w500,
                                          ),
